...
/// has been opened.
pub fn probe_memory_protection() -> (absentia_core::Assurance, &'static str) {
    let _ = SecretBytes::<32>::zeroed();
    memory_protection_status()
}

pub fn memory_protection_status() -> (absentia_core::Assurance, &'static str) {
    use absentia_core::Assurance;
    match lock::outcome() {
...
mod tests {
    ...
    fn locking_is_attempted_and_its_outcome_is_reported_truthfully() {
        ...
        assert_ne!(assurance, absentia_core::Assurance::NotAttempted);
        assert_ne!(
            assurance,
            absentia_core::Assurance::Verified,
