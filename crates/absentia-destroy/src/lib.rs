...
use absentia_core::time::TimeAnchor;
use absentia_core::{Assurance, Error, Result, VaultId};
use absentia_format::{HEADER_LEN, WRAPPED_KEY_LEN};
use absentia_journal::{AuditAnchor, JournalStatus, StateJournal};
use absentia_platform::sanitizer as platform_sanitizer;
...
impl DestructionReport {
    ...
    pub fn render(&self) -> String {
        ...
        s.push_str("APEX ABSENTIA DESTRUCTION REPORT\n\n");
