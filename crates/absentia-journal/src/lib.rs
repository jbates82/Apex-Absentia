...
//!
//! State transitions are checked against the rules in `absentia-core::state`
...
use absentia_core::state::{transition, DeadmanState};
use absentia_core::time::TimeAnchor;
use absentia_core::{Error, Result, VaultId};
use absentia_crypto::sha256;
...
impl StateRecord {
    fn compute_hash(&self) -> [u8; 32] {
        ...
        b.extend_from_slice(b"apex-absentia:journal:v1");
...
///
/// See the equivalent in `absentia-audit` for why a damaged line is reported
