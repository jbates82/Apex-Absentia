...
//!
//! The organization holds an Ed25519 signing key. Absentia holds only the
...
impl RemoteCommand {
    ...
    fn signing_payload(
        ...
        b.extend_from_slice(b"apex-absentia:remote-command:v1");
...
impl SigningIdentity {
    pub fn generate() -> Self {
        let mut seed = [0u8; 32];
        absentia_crypto::random_bytes(&mut seed);
    ...
    pub fn issue(
        ...
        absentia_crypto::random_bytes(&mut nonce);
