//! Shared types and errors for Apex Absentia.
//!
...
/// Every fallible operation in Absentia reports through this type.
///
...
///
/// Absentia must never report success it did not observe, so every assurance
